<?php
/*
Template Name: -- Slider right two
*/
?>  
...
jQuery(document).ready(function ($) {
   ...
   var custom_controls_boxrr = ".flexslider-controls-box-<?php the_id(); ?>";
   var custom_sliderrr = ".flexslider-small-<?php the_id(); ?>";

    $(custom_sliderrr).flexslider({
        animation: 'fade',
        touch: true,
        slideshow: false,
        controlNav: true,
        directionNav: false,
        smoothHeight: true,
        controlsContainer:  custom_controls_boxrr
    });
     });
